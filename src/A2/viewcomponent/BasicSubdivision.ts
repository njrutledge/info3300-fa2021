 ...
 *  this boundary. Specifically, we subdivide the boundary by generating a new array of
 *  connected vertices.
 *  This new array of vertices includes:
 ...
 *  If we subdivide this triangle A, we would consider {p1, p2, p3} as its old vertices.
 *  The new vertices would include:
 *      1. midpoints of each old edge:
