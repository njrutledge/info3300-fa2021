import {Precision, TransformationInterface, Vector} from "src/anigraph";

export class BoundingBox<VertexType extends Vector, TransformType extends TransformationInterface>{
