...
export class AObject{
     ...
     */
    addStateKeyListener(state_key:string, callback:(self:AObject)=>void, synchronous:boolean=true, handle?:string){
    ...
    addStateListener(callback:(self:AObject)=>void, synchronous:boolean=true, handle?:string){
        var h:string = handle?handle:(uuidv4() as string);
        const object = this;
