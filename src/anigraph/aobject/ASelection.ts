/**
 * # ASelection
 * Template class for selections of things. Allows for functions that are called upon selection and deselection.
 */
...
export class ASelection<T>{
     ...
     * By default, it uses a hash, but this can be overwritten for specific selection types.
     * @param item
     * @returns {any}
     * @private
     */
     ...
     * @param exitCallback - a function to run on items that leave the selection
     * @param enterCallback - a function to run on items that enter the selection
     * @param updateCallback - a function to run on items that stay in the selection
     */
